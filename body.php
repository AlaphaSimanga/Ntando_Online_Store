            ...
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <img src="img/hero.jpg" alt="Los Angeles" style="width:100%;">
                    </div>
                    <div class="item">
                        <img src="img/hero.jpg" style="width:100%;"> 
                    </div>
                    <div class="item">
                        <img src="img/hero.jpg" alt="New York" style="width:100%;">
                    </div>
                    <div class="item">
                        <img src="img/hero.jpg" alt="New York" style="width:100%;">
                    </div>
							...
							<div id="tab1" class="tab-pane active">
								<div class="products-slick" data-nav="#slick-nav-1" >
								    ...
								    <?php
				                        ...
				                        $product_query = "SELECT * FROM products,categories WHERE product_cat=cat_id AND product_id BETWEEN 1 AND 60";
                                                ...
                                                echo "
								                    ...
								                    <div class='product'>
									                    ...
									                    <div class='product-body'>
										                    ...
										                    <h4 class='product-price header-cart-item-info'>$pro_price<del class='product-old-price'>R990.00</del></h4>
